...
lineage_genes= ['LHX8','LHX6','NKX2-1','MAF','CRABP1','RBP4','TAC3','PROX1','NR2F1','NR2F2','SP8','ETV1','PAX6','TSHZ1','FOXP1','FOXP2','CASZ1','MEIS2','EBF1','ISL1','PENK','ADORA2A','ZIC1','ZIC4','NPY','CORT','CHODL','HMX3','GBX1','DBX1','OTP','SIX3']#GSX2,VAX1,'SALL3'
...
for branch in ['S-phase','G2-M','MGE|LGE|CGE|VMF|Transition']:#'MGE','CGE','LGE'
    values=[]
    times=[]
    bdata=adata[adata.obs['supervised_name'].str.contains(branch),:].copy()
